...
function Contact() {
  ...
  // Generate fake media data using Faker
  const mediaItems = [
    { 
      id: 1, 
      type: "image", 
      src: faker.image.urlLoremFlickr({ width: 60, height: 60, category: 'car' }), 
      alt: "Car 1" 
    },
    { 
      id: 2, 
    ...
    { 
      id: 3, 
      type: "image", 
      src: faker.image.urlLoremFlickr({ width: 60, height: 60, category: 'nature' }), 
      alt: "Nature" 
    },
  ];
