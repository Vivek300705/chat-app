...
function Contact() {
  ...
  // Handler functions with enhanced logging
  const handleSharedClick = () => {
    console.log("📤 Shared Messages clicked - dispatching SHARED");
    dispatch(updateSidebarType("SHARED"));
  };

  const handleStarredClick = () => {
    console.log("⭐ Starred Messages clicked - dispatching STARRED");
            ...
            >
              ...
              <Stack direction="row" alignItems="center" spacing={1}>
                ...
                <IconButton size="small">
                  <CaretRight size={16} color={isDark ? "#aaa" : "#666"} />
                </IconButton>
              </Stack>
            </Stack>
