// 📦 All updated message components
...
import { FileText, ArrowBendUpLeft, Download } from "phosphor-react";
import MessageOptions from "./MessageOptions";

const MessageWrapper = ({ isIncoming, children }) => {
  return (
    <Stack
      direction="row"
...
export function TxtMsg({ el }) {
  ...
  return (
    <MessageWrapper isIncoming={isIncoming}>
      <Box
        p={1.5}
        sx={{
